...
const preimage0 = Array(16).fill(0n);
const preimage1 = Array(16).fill(1n);
...
describe("End2End", function () {
    ...
    before(async function () {
        ...
        const HashCollisionBounty = buildContractClass(result);
        ...
        ContractTypes = buildTypeClasses(HashCollisionBounty);

        infoBounty = new HashCollisionBounty(
    ...
    it('Testing parsing and decrypting solution',
        async function () {
            ...
            expect(_w).to.equal(preimage0.concat(preimage1));
        }
    );
